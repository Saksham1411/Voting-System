        ...
        <AuroraBackground>
            ...
            >
                <div className='w-2/5 h-fit bg-white/10 backdrop-blur-lg  px-5 py-8 flex flex-col justify-center items-center text-center text-lg rounded-3xl border border-white/70 shadow-sm shadow-white/40'>
                    <h1 className='font-fredoka text-2xl tracking-widest font-medium text-white/90'>REGISTRATION</h1>
                    ...
                    <form className='w-full flex flex-col items-center justify-center' onSubmit={handleSubmit}>
                        ...
                        <div className="field-div">
                            ...
                            <input className='px-2 py-2 w-full text-white/80 tracking-wider focus:text-white/80 bg-transparent focus:outline-none'
                        ...
                        <div className="field-div">
                            ...
                            >
                                ...
                                <optgroup className='text-black' id="country-optgroup-Americas" label="Americas">
                                ...
                                <optgroup className='text-black' id="country-optgroup-Asia" label="Asia">
                                ...
                                <optgroup className='text-black' id="country-optgroup-Europe" label="Europe">
                                ...
                                <optgroup className='text-black' id="country-optgroup-Oceania" label="Oceania">
